 ...
 * @inheritdoc
 */
class Common extends \yii\web\Application
{
    ...
    public function bootstrap()
    {
        ...
        if (Yii::getAlias('@web-static', false) === false) {
            Yii::setAlias('@web-static', $request->getBaseUrl() . '/assets');
        }

        if (Yii::getAlias('@webroot-static', false) === false) {
            Yii::setAlias('@webroot-static', '@webroot/assets');
        }
    ...
    /**
     *
     * @return string $value the theme URL
     */
