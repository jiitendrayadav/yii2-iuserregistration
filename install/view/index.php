        ...
        <div class="install-box">
            ...
            <div class="panel panel-install">
                <div class="panel-heading text-center">
                    <h2> iKodes Technology iAccounts - Installation</h2>
                </div>
                <div class="panel-body no-padding">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="finished-tab">
                            <div class="section">
                                <div class="clearfix">
                                    <i class="status fa fa-check-circle-o pull-left" style="font-size: 50px"> </i><span class="pull-left"  style="line-height: 50px;">Congratulation! You have successfully installed - Project</span>
                                </div>

                                <div style="margin: 15px 0 15px 60px; color: #d73b3b;">
                                    Don't forget to delete your installation directory!
                                </div>
                                <a class="go-to-login-page" target="_blank" href="<?php echo $dashboard_url; ?>">
                        ...
                        <div class="text-center m-b-10">
                            <a href="//ikodes.net">iKodes Technology</a>
                        </div>
                    </div>
                </div>
            </div>
